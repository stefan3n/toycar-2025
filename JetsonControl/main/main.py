...
from avoid_obs import obstacle_avoider_process
...
def main():
    ...
    try:
        ...
        checkPorts(ports, logger)
       
       
        pipe_to_motors, pipe_to_obstacle = Pipe() 
       
        # Process objects for all devices
        if True: 

            robot = Process(target=ArduinoProcess, args=(ports[2],loggerRobot,))
        ...
        while True:
            ...
            if response != None:
                ...
                if response[0] == ServerCommands.AUTONOMOUS:
                    ...
                    carObj.startAutonomousAvoidance()
