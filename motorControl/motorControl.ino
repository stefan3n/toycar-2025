...
void setup()
{
  ...
  initMotor(motorRF, MOTOR_RF_PWM, MOTOR_RF_DIR, MOTOR_RF_SPEED, RIGHT_DIR_DEFAULT);
  initMotor(motorRB, MOTOR_RB_PWM, MOTOR_RB_DIR, MOTOR_RB_SPEED, RIGHT_DIR_DEFAULT);
  initMotor(motorLB, MOTOR_LB_PWM, MOTOR_LB_DIR, MOTOR_LB_SPEED, LEFT_DIR_DEFAULT);
  initMotor(motorLF, MOTOR_LF_PWM, MOTOR_LF_DIR, MOTOR_LF_SPEED, LEFT_DIR_DEFAULT);
